...
{
  "\"end of file\"", "error", "\"invalid token\"", "ARTICULO", "EOL",
  "$accept", "cadena", YY_NULLPTR
};
...
yyreduce:
  ...
  case 2:
#line 9 "sintactico.y"
                     {printf("Se imprimio una cadena\n");}
#line 1102 "sintactico.tab.c"
    break;

  case 3:
#line 10 "sintactico.y"
                           {yyerror("Articulo duplicado\n");}
